...
{
    /// <summary>
    /// Отрисовывает меню и обрабатывает операции с ними.
    /// </summary>
    internal static class Menu
    {
        /// <summary>
        /// Обрабатывает все операции, связанные с меню.
        /// </summary>
        ...
        public static int ProcessCurrentMenu(string mainTile, string postTile, params string[] titles)
        {
            Console.Clear();
